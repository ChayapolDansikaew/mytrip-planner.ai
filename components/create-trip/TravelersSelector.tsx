        ...
        {travelerOptions.map((option) => {
          ...
          return (
            <button
              ...
              className={cn(
                "group flex items-start gap-4 rounded-[1.35rem] border bg-white/78 p-5 text-left shadow-[0_18px_50px_rgba(15,58,100,0.08)] backdrop-blur transition duration-300 hover:-translate-y-1 hover:border-[#ff3f78]/55 hover:bg-white hover:shadow-[0_24px_70px_rgba(255,63,120,0.16)]",
                isSelected
                  ? "border-[#ff3f78] bg-[#fff0f5] ring-4 ring-[#ff3f78]/15"
                  : "border-white/70",
              )}
            >
              <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-[#9de9f4]/55 text-2xl transition group-hover:scale-105">
                {option.emoji}
              </span>
              <span>
                <span className="block text-lg font-semibold tracking-[-0.02em] text-[#0f3a64]">
                  {option.title}
                </span>
